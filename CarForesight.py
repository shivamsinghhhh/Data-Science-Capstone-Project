...
model = pickle.load(open('rf_model_car1.pkl','rb'))
df = pickle.load(open('data_car1.pkl','rb'))
...
def main():
    ...
    # Page title
    st.title('🚗 Used Car Data EDA By Shivam Singh')
    ...
    with col1:
        if st.sidebar.button('GitHub'):
            st.sidebar.markdown('[Visit my GitHub profile and check the codes](https://github.com/shivamsinghhhh)')
    with col2:
        if st.sidebar.button('LinkedIn'):
            st.sidebar.markdown('[Visit my LinkedIn profile](https://www.linkedin.com/in/shivam-singh-hhh/)')
